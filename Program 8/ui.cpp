...
bool translate(char option, table& user_table)
{
	 ...
	 if ('A' == option)
	 {
		  ...
		  if (user_table.add_item(name, an_item) == 0)
			   cout << endl << "Error";
	 }
	 else if ('B' == option)
	 {
		  if (!user_table.load(name, desc, type, platform, rate))
	 ...
	 else if ('C' == option)
	 {
		  ...
		  cout << "------------------------------" << endl;
		  if (user_table.display(itemName) == 0)
	 ...
	 else if ('D' == option)
	 {
		  ...
		  cin.get(itemName, 100, '\n');
		  cin.ignore(100, '\n');
		  if (user_table.retrieve(itemName, retrieved) == 0)
	 ...
	 else if ('E' == option)	
	 {
		  ...
		  cin.get(itemName, 100, '\n');
		  cin.ignore(100, '\n');
		  if (user_table.remove(itemName) == 0)
			   cout << "There are no items by that name!";
		  else 
	 ...
	 else if ('F' == option)
	 {
		  ...
		  cout << "------------------------------" << endl;
		  if (user_table.display_type(type) == 0)
			   cout << "There are no items by that type!";
	 }
	 else if ('G' == option)
	 {
		  if(user_table.display_all() == 0)
			   cout << endl << "No Table yet";
	 }
	 else if ('H' == option)
	 {
		  again = false;
